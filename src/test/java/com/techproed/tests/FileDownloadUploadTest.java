...
public class FileDownloadUploadTest extends TestBase {
    ...
    public void dosyaVarMi(){
        ...
        // C:\Users\isimsiz\IdeaProjects\SeleniumReviewTestNG\pom.xml
        boolean varMi = Files.exists(Paths.get("C:\\Users\\thevi\\Desktop\\SeleniumReviewTestNG\\pom.xml"));
    ...
    public void dosyaUpload(){
        ...
        chooseFile.sendKeys("C:\\Users\\thevi\\Desktop\\SELENIUM_REVIEW\\logo.png");
    ...
    public void dosyaIndirme(){
        ...
        WebElement flowerLink=driver.findElement(By.linkText("FLOWER. IMG.jpg"));
        flowerLink.click();
        ...
        // Downloads//FLOWER. IMG.jpg
        //(Not: Downloads klasorunun yolu bende sadece Downloads olarak gozukuyor. Ancak, bu sekilde yaptigimda hata verdi.
        // Ben de yolu C:\Users\thevi\Downloads olarak yazdim, calisti)

        // DOSYA VARSA - TRUE       DOSYA YOKSA - FALSE
        boolean varMi=Files.exists(Paths.get("C:\\Users\\thevi\\Downloads\\FLOWER. IMG.jpg"));
